...
import { UPDATE_RERENDER_MYTASKS , UPDATE_ALL_TASKS} from "../utils/actions";
...
const allTasks = useQuery(QUERY_TASKS,{
  onCompleted: ()=>{dispatch({ type: UPDATE_ALL_TASKS, payload: allTasks.data.tasks})}
});
